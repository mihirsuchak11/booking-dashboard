...
import { SocialProofBarV2 } from "./social-proof-bar-v2";
...
export function HeroSectionV2() {
  return (
    ...
    >
      <HeroBackground />
      <div className="container relative z-10 mx-auto px-[20px] pt-24 lg:pt-28 pb-10 sm:pb-12 lg:pb-16 xl:max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md">
              <Image
                src="/landing/hero/ai-receptionist-4.png"
                alt="AI Receptionist"
                width={600}
                height={800}
